...
public class PlayerMovement : MonoBehaviour
{
    ...
    float timeForDamageCooldown = 1f;
	...
	void OnCollisionEnter(Collision other)
    {
        ...
        */
        ...
        if (other.gameObject.CompareTag("Turing"))
        {
            ...
            TakeDamage(5);
            // Bounce wayyy off.
            const float TOTAL_POWER = 100f;
            Vector3 reverseNormal = -Vector3.Normalize(rb.velocity);
            rb.AddForce(reverseNormal.x * TOTAL_POWER, 0, reverseNormal.z * TOTAL_POWER, ForceMode.Impulse);
        }
        if (other.gameObject.CompareTag("Spikes"))
        {
            ...
            TakeDamage(5);
            // Bounce up high.
            const float TOTAL_POWER = 10f;
            rb.AddForce(0f, TOTAL_POWER, 0f, ForceMode.Impulse);
