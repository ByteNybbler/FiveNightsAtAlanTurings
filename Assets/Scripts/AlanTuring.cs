...
public class AlanTuring : MonoBehaviour
{
    ...
    float timeForCharge = 10f; //500;
    float timeForSpike = 20f; //1000;
    float timeForLaser = 0.1f; //3;
    ...
    private void Update()
    {
        ...
        while (chargeTimer < 0f)
        {
            ...
            chargeVector = heading / heading.magnitude * chargeSpeed * Time.deltaTime;
